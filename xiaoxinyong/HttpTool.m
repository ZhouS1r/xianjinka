...
+(void)sendRequestWithUrl2:(NSString *)urlString functionName:(NSString*)functionName paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues success:(void (^)(NSData * data))success failure:(void (^)(NSError * error))failure{
    NSMutableString *soapMessage =[NSMutableString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?>"
                                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                                   "<soap:Body>"
                                   "<%@ xmlns=\"http://chachaxy.com/\">",functionName];
    for (int i = 0; i < paramValues.count; i ++) {
        id value = paramValues[i];
        if ([value isKindOfClass:[NSNumber class]]) {
            int intvalue = [(NSNumber *)value intValue];
...
+(void)sendRequestWithUrl3:(NSString *)urlString functionName:(NSString*)functionName paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues success:(void (^)(NSData * data))success failure:(void (^)(NSError * error))failure{
    NSMutableString *soapMessage =[NSMutableString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?>"
                                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                                   "<soap:Body>"
                                   "<%@ xmlns=\"http://liulongzhu.com/\">",functionName];
